    ...
    <section
      ...
      >
        ...
        <h1 className='mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82px] font-bold'>
          ...
          <p className='font-montserrat text-slate-gray text-lg leading-8 nt-6 mb-10 sm:max-w-sm'>Discover stylish Nike arrivals, quality comfort, and innovation for your active life.</p>
